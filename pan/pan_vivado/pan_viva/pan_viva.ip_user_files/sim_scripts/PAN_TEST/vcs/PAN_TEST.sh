...
design_libs=(xpm xil_defaultlib util_vector_logic_v2_0_3 xlconstant_v1_1_8)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  vlogan -work util_vector_logic_v2_0_3 $vlogan_opts +v2k +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  vlogan -work xlconstant_v1_1_8 $vlogan_opts +v2k +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PAN_TEST xil_defaultlib.glbl -o PAN_TEST_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PAN_TEST_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/build/fukun/pan_vivado/pan_viva/pan_viva.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key PAN_TEST_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PAN_TEST_simv.daidir vcs_lib c.obj)
