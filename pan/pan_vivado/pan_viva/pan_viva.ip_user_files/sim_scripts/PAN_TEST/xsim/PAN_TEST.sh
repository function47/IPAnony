...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L util_vector_logic_v2_0_3 -L xlconstant_v1_1_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PAN_TEST xil_defaultlib.PAN_TEST xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PAN_TEST -key {Behavioral:sim_1:Functional:PAN_TEST} -tclbatch cmd.tcl -protoinst "protoinst_files/PAN_TEST.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PAN_TEST.wdb xsim.dir libdpi.so)
