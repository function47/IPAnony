...
#
# Script generated by Vivado on Fri Nov 22 03:53:54 UTC 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : PAN_TEST.sh
...
#
# Usage        : PAN_TEST.sh
#                PAN_TEST.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PAN_TEST.sh [-reset_run]
#                PAN_TEST.sh [-reset_log]
#                PAN_TEST.sh [-help]
#
...
#                script (type 'PAN_TEST.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname util_vector_logic_v2_0_3 -libname xlconstant_v1_1_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib util_vector_logic_v2_0_3 xlconstant_v1_1_8)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "PAN_TEST.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PAN_TEST.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  xmvlog -work util_vector_logic_v2_0_3 $xmvlog_opts +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ipshared/c2c6" +incdir+"../../../../pan_viva.gen/sources_1/bd/PAN_TEST/ip/PAN_TEST_pan_0_0/drivers/pan_v1_0/src" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.PAN_TEST xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.PAN_TEST -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/build/fukun/pan_vivado/pan_viva/pan_viva.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log PAN_TEST_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PAN_TEST.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PAN_TEST.sh [-help]\n\
Usage: PAN_TEST.sh [-step]\n\
Usage: PAN_TEST.sh [-lib_map_path]\n\
Usage: PAN_TEST.sh [-reset_run]\n\
Usage: PAN_TEST.sh [-reset_log]\n\
Usage: PAN_TEST.sh [-keep_index]\n\
Usage: PAN_TEST.sh [-noclean_files]\n\n\
